...
title: 'Anthropics $100-Mrd.-Wette auf AWS: Was der Mega-Deal für Claude-Nutzer bedeutet'
description: 'Anthropics $100-Mrd.-Wette auf AWS: Was der Mega-Deal für Claude-Nutzer bedeutet'
pubDate: '2026-04-21'
author: 'Robin Böhm'
...
- 📰 [Original-Artikel: Anthropic's $100B Amazon Compute Deal (Axios)](https://www.axios.com/2026/04/21/anthropic-amazon-compute-wars)
- 📚 [Anthropic & AWS: Offizielle Partnerschafts-Ankündigung (anthropic.com)](https://www.anthropic.com/news/anthropic-amazon-trainium)
- 📚 [Amazon & Anthropic: Strategic Collaboration (aboutamazon.com)](https://www.aboutamazon.com/news/company-news/amazon-invests-additional-5-billion-anthropic-ai)
- 🎓 **Workshops & Kurse** (verifiziert via workshops.de API):
  - [Claude: Modul 1 – Chat und die Anthropic Platform](https://workshops.de/courses/claude-for-beginner) — Einstieg in Claude, CoWork und die Anthropic API
  - [Claude: Modul 2 – Agents mit Claude, CoWork, Skills und Plugins](https://workshops.de/schulungsthemen/claude) — Workflows und Automatisierungen mit Claude bauen
  - [Claude: Modul 3 – Agentic Software Engineering with Claude Code](https://workshops.de/courses/software-engineering-claude-code) — Multi-Agent-Workflows und CI/CD-Integration
