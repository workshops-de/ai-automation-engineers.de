...
2. **Automatische Anreicherung**: KI fügt passende filmische Begriffe hinzu

3. **Batch-Processing**: Mehrere Varianten parallel generieren
...
1. **Google Sheets**: Liste mit Basis-Prompts

2. **OpenAI GPT-4**: Anreicherung mit cinematischen Begriffen

3. **Midjourney/Runway API**: Batch-Generierung

4. **Computer Vision**: Automatische Qualitätsprüfung
...
2. **Teste die Begriffe systematisch** in deinem bevorzugten AI-Tool
...
- 🎓 [AI-Video Workshop auf workshops.de](https://workshops.de?utm_source=ai-automation-engineers_de&utm_campaign=article_referral&utm_medium=portal&utm_content=26-filmische-begriffe-die-deine-ai-videos-revolutionieren)
...
1. **Midjourney Version**: V6 → V7 (aktuelle Version seit Juni 2025)

2. **Runway Modelle**: Präzisierung Gen-3 Alpha / Gen-4

3. **Tool-Liste**: Pika 2.0 entfernt (nicht verifizierbar für Nov. 2025)

4. **Zeitersparnis-Claims**: Von spezifischen Zahlen (80%, 10-15 vs 2-3) zu Erfahrungswerten umformuliert
